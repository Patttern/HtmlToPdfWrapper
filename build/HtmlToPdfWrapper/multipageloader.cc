...
namespace wkhtmltopdf {
  ...
  /**
   * @brief Once loading starting, this is called
   */
   ...
   * @param p the loading progress in percent
   */
  ...
  /**
   * @brief Called when the page requires authentication, fills in the username
  ...
  /**
   * @brief Track and handle network errors
  ...
  /**
   * @brief Handle any ssl error by ignoring
   * @param reply ???
   */
  ...
  /**
   * @brief Copy a file from some place to another
