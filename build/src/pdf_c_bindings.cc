 ...
 * @return A wkhtmltopdf global settings object
 */
 ...
 * @param obj ???
 */
void wkhtmltopdf_destroy_global_settings(wkhtmltopdf_global_settings * obj) {
 ...
 * @return 1 if the setting was updated successfully and 0 otherwise.
 ...
 * @return 1 If the the setting exists and was read successfully and 0 otherwise
 ...
 * @return an object settings instance
 */
 ...
 * @param obj ???
 */
void wkhtmltopdf_destroy_object_settings(wkhtmltopdf_object_settings * obj) {
 ...
 * @return A wkhtmltopdf converter object
 */
wkhtmltopdf_converter * wkhtmltopdf_create_converter(wkhtmltopdf_global_settings * settings) {
  return reinterpret_cast<wkhtmltopdf_converter *>(new MyPdfConverter(reinterpret_cast<settings::PdfGlobal *>(settings)));
}
 ...
 * be accessed.
 * @param converter The converter object to destroy
 */
 ...
 */
void wkhtmltopdf_add_object(wkhtmltopdf_converter * converter, wkhtmltopdf_object_settings * settings, const char * data) {
  QString str= QString::fromUtf8(data);
  reinterpret_cast<MyPdfConverter *>(converter)->converter.addResource(*reinterpret_cast<settings::PdfObject *>(settings), &str);
 ...
 */
long wkhtmltopdf_get_output(wkhtmltopdf_converter * converter, const unsigned char ** d) {
